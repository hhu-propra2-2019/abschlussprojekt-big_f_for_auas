...
public class FakeDatePollInfoService {
    ...
    public Set<DatePoll> genRandomDatePolls(UserId userid) {
        ...
        for (int i = 0; i<10; i++) {
            ...
            final Timespan timespan = new Timespan(LocalDateTime.now(), LocalDateTime.of(2020 + i, 3,20, 19, 50, 56));
            final DatePollMetaInf datePollMetaInf = new DatePollMetaInf("Abstimmung : " + i, "Beschreibung :" + i, "Bei Nathan", timespan);
            ...
            final DatePollLink datePollLink = new DatePollLink();
            final DatePoll testDatePoll = new DatePoll(datePollRecordAndStatus, datePollMetaInf, userid, datePollConfig, datePollEntries, participants, datePollBallots, datePollLink);
