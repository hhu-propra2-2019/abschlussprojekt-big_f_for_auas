...
public class QuestionPollHeaderTest { //NOPMD
    ...
    public void allEmpty() {
        ...
        this.testValidator = this.testValidator
                .appendValidation(new Validation(FieldErrorNames.QUESTION_POLL_HEADER_TITLE_IS_EMPTY))
                .appendValidation(new Validation(FieldErrorNames.QUESTION_POLL_QUESTION_IS_EMPTY));
        final Validation validator = header.validate();
        assertThat(this.testValidator.getErrorMessages()).isEqualTo(validator.getErrorMessages());
    }
}
